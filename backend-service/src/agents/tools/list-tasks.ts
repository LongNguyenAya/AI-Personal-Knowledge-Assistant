  ...
  return tool({
    ...
    inputSchema: z.object({
      ...
      from: z
        ...
        .optional()
        .describe(
          "Mốc bắt đầu khoảng thời gian cần lọc, ISO 8601 (vd user hỏi 'trong tháng 7' thì lấy đầu tháng 7 theo giờ VN, quy đổi sang UTC). Bỏ trống nếu user không giới hạn thời gian. Nếu onlyDone=true, lọc theo thời điểm HOÀN THÀNH; ngược lại lọc theo thời điểm TẠO task."
        ),
